...
<body>
    ...
    <div class="main-content">
      ...
      <div id="patient-list-section" class="content-section" style="margin-top: 30px; display: none;">
              ...
              <table id="patient-table" style="width: 100%; border-collapse: separate; border-spacing: 0; min-width: 700px; background: white; border-radius: 18px; overflow: hidden; box-shadow: 0 4px 16px rgba(108,51,110,0.07);">
                  ...
                  <tbody>
                      ...
                      try {
                          ...
                          $stmt = $pdo->query("SELECT patient_id, first_name, middle_name, last_name, age, gender, status 
                          ...
                          if ($patients) {
                              foreach ($patients as $index => $patient) {
                                  $rowStyle = $index % 2 === 0 ? "background: #fff; border-bottom: 1px solid #f3e6f7;" : "background: #faf6fa;";
                                  $fullName = trim($patient['first_name'] . ' ' . ($patient['middle_name'] ? $patient['middle_name'] . ' ' : '') . $patient['last_name']);
                                  ?>
                                  <tr style="<?php echo $rowStyle; ?>">
                                      <td style="padding: 14px 18px;">PAT-<?php echo str_pad($patient['patient_id'], 4, '0', STR_PAD_LEFT); ?></td>
                                      <td style="padding: 14px 18px;"><?php echo htmlspecialchars($fullName); ?></td>
                                      <td style="padding: 14px 18px;"><?php echo htmlspecialchars($patient['age']); ?></td>
                                      <td style="padding: 14px 18px;"><?php echo htmlspecialchars($patient['gender']); ?></td>
                                      <td style="padding: 14px 18px;"><?php echo htmlspecialchars($patient['status']); ?></td>
                              ...
                              echo "<tr><td colspan='6' style='padding:14px 18px; text-align:center;'>No patients found.</td></tr>";
                          }
                      } catch (PDOException $e) {
                          echo "<tr><td colspan='6' style='padding:14px 18px; color:red;'>Error: " . htmlspecialchars($e->getMessage()) . "</td></tr>";
                      }
                      ?>
                  </tbody>
              </table>
        ...
        <div id="medical-records-section" class="content-section" style="margin-top: 30px;  background: #f9fafc; border-radius: 20px;">
